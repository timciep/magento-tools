...
SUPEE-9341 | EE_1.14.0.0 | v1 | 7904de5d2ada2ec89b35bc99bb1fd2cf0e92a2d4 | Mon Nov 14 10:57:30 2016 -0800 | 7529e264e349bfdd944ce6340b88c7567b8ae5fd..7904de5d2ada2ec89b35bc99bb1fd2cf0e92a2d4

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Mage/Core/Model/Config.php app/code/core/Mage/Core/Model/Config.php
index 3e27cc9..45a105b 100644
--- app/code/core/Mage/Core/Model/Config.php
+++ app/code/core/Mage/Core/Model/Config.php
@@ -37,6 +37,16 @@ class Mage_Core_Model_Config extends Mage_Core_Model_Config_Base
     const CACHE_TAG         = 'CONFIG';
 
     /**
+     * Number of attempts to retrieve a locked cache
+     */
+    const CACHE_LOAD_ATTEMPTS = 10;
+
+    /**
+     * Delay between load attempts in microseconds
+     */
+    const CACHE_LOAD_RETRY_DELAY = 500000;
+
+    /**
      * Flag which allow use cache logic
      *
      * @var bool
@@ -411,8 +421,17 @@ class Mage_Core_Model_Config extends Mage_Core_Model_Config_Base
      */
...
+            $retries = self::CACHE_LOAD_ATTEMPTS;
+            do {
+                if (!$this->_loadCache($this->_getCacheLockId())) {
+                    return true;
+                }
+                usleep(self::CACHE_LOAD_RETRY_DELAY);
+            } while (--$retries);
+        }
+
+        return false;
     ...
     /**
@@ -453,25 +472,29 @@ class Mage_Core_Model_Config extends Mage_Core_Model_Config_Base
